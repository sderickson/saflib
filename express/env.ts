/**
 * Environment variables for the `@saflib/express` package, including inherited variables.
...
export interface ExpressEnvSchema {
  /**
 ...
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as ExpressEnvSchema;
