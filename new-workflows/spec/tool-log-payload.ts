 ...
 * plain-text format — see `@saflib/new-workflows` `claude-agent.ts`.
 *
 * Lives in the spec package so the SPA can import it without pulling the
 * Node-only workflow engine barrel (minimatch, git, copy steps, …).
 */
