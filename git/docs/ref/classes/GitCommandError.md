...
> **new GitCommandError**(`message`, `options`): `GitCommandError`
...
| ------------------- | ------------------------------------------------------------------------------------------------------------- |
| `message`           | `string`                                                                                                      |
| `options`           | \{ `args`: readonly `string`[]; `cause?`: `unknown`; `exitCode?`: `null` \| `number`; `stderr?`: `string`; \} |
| `options.args`      | readonly `string`[]                                                                                           |
| `options.cause?`    | `unknown`                                                                                                     |
| `options.exitCode?` | `null` \| `number`                                                                                            |
