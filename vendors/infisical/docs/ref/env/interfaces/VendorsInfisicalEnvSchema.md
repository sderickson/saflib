...
# Interface: VendorsInfisicalEnvSchema
...
> `optional` **INFISICAL\_ENVIRONMENT**: `string`

Infisical environment slug (e.g. dev, staging, prod). Optional when INFISICAL_TOKEN is "mock".

---

### INFISICAL\_PROJECT\_ID?

> `optional` **INFISICAL\_PROJECT\_ID**: `string`
