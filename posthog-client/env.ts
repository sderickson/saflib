...
/**
 * Environment variables for the `@saflib/posthog-client` package, including inherited variables via `extends`.
 ...
 */
export interface PosthogClientEnvSchema extends EnvEnvSchema {
