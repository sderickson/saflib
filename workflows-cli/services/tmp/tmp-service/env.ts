/**
 * Environment variables for the `tmp-service` package, including inherited variables.
...
export interface TmpServiceEnvSchema {
  /**
...
/**
 * `process.env` casted to the `TmpServiceEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TmpServiceEnvSchema;
