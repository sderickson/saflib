/**
 * Environment variables for the `tmp-service-common` package, including inherited variables.
...
export interface TmpServiceCommonEnvSchema {
  /**
  ...
  TMP_SERVICE_HOST: string;
  TMP_SERVICE_HTTP_PORT: string;
  /**
...
/**
 * `process.env` casted to the `TmpServiceCommonEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TmpServiceCommonEnvSchema;
