...
- Rename "CwdStepMachine" to "CdStepMachine", and related types.
...
- Fix typo
- Standardize "prompt" inputs in steps
- Rename "promptOnError" to "errorPrompt"
- Make "name" optional for copy step
- Remove broken "prompt" function for update step input

## [0.2.2] - 2025-11-16

### Changed

- Simplify add-workflow workflow.
- Improve CLI docs
