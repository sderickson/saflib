...
const sourceDir = path.join(import.meta.dirname, "experiments");
...
interface ExperimentWorkflowContext {
  name: string;
  targetDir: string;
  exampleProperty: string;
}

export const ExperimentWorkflowDefinition = defineWorkflow<
  typeof input,
...
>({
  ...
  // TODO: create the experiments dir and add template files
