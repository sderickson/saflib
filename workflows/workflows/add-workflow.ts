  ...
  steps = [
    {
      ...
      prompt: () =>
        `The file '${this.computed().workflowPath}' has been created. Fill in the TODOs (name and description), then review the file to get oriented. Do NOT work on the machine itself yet.`,
    },
    {
