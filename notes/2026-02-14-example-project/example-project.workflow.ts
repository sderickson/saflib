...
interface ExampleProjectWorkflowContext {}

export const ExampleProjectWorkflowDefinition = defineWorkflow<
  typeof input,
  ExampleProjectWorkflowContext
>({
  id: "plans/example-project",
  description: "Project example-project workflow",
  input,
  context: () => ({}),
...
export default ExampleProjectWorkflowDefinition;
