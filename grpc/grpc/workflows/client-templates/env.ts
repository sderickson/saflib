/**
 * Environment variables for the `template-package-grpc-client` package, including inherited variables.
 ...
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TemplatePackageGrpcClientEnvSchema;
