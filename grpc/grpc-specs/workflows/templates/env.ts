/**
 * Environment variables for the `@template/file-protos` package, including inherited variables.
...
export interface FileProtosEnvSchema {
  /**
   ...
   */
  TEMPLATE_FILE_SERVICE_GRPC_PORT: string;
  TEMPLATE_FILE_SERVICE_HOST: string;
  TEMPLATE_FILE_SERVICE_HTTP_PORT: string;
  /**
