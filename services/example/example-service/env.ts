/**
 * Environment variables for the `example-service` package, including inherited variables.
...
export interface ExampleServiceEnvSchema {
  /**
  ...
  EXAMPLE_SERVICE_HOST: string;
  EXAMPLE_SERVICE_HTTP_PORT: string;
  /**
...
/**
 * `process.env` casted to the `ExampleServiceEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as ExampleServiceEnvSchema;
