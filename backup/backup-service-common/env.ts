/**
 * Environment variables for the `@saflib/backup-service-common` package, including inherited variables.
 ...
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as BackupServiceCommonEnvSchema;
