...
export interface CombinedEnvSchema {
  ...
  /**
   * Whether to block the creation of new databases. Useful for ensuring existing production environments don't inadvertently create new databases.
   */
  BLOCK_DB_CREATION?: "true" | "false";
}
