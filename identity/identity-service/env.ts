/**
 * Environment variables for the `@saflib/identity-service` package, including inherited variables.
 ...
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as IdentityServiceEnvSchema;
