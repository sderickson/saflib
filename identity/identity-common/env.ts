/**
 * Environment variables for the `@saflib/identity-common` package, including inherited variables.
...
export interface IdentityCommonEnvSchema {
  /**
...
/**
 * `process.env` casted to the `IdentityCommonEnvSchema` type.
 */
export const typedEnv = (globalThis.process
  ? process.env
  : {}) as unknown as IdentityCommonEnvSchema;
