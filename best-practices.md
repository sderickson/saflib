...
- `@saflib/utils` provides a [`ReturnsError`](./utils/docs/ref/index/type-aliases/ReturnsError.md) type for such functions, and a [`throwError`](./utils/docs/ref/index/functions/throwError.md) helper function.
