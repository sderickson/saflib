...
- Copy template files and rename placeholders.
  ...
  - Upsert **vuetify-settings.scss** from [template](https://github.com/sderickson/saflib/blob/main/vue/workflows/template/__product-name__-clients/vuetify-settings.scss)
  - Upsert **vuetify-overrides.scss** from [template](https://github.com/sderickson/saflib/blob/main/vue/workflows/template/__product-name__-clients/vuetify-overrides.scss)
  - Upsert **globals.scss** from [template](https://github.com/sderickson/saflib/blob/main/vue/workflows/template/__product-name__-clients/globals.scss)
  - Upsert **package.json** from [template](https://github.com/sderickson/saflib/blob/main/vue/workflows/template/__product-name__-clients/package.json)
