...
| [getElementByString](variables/getElementByString.md)       | This should always be used to find elements in tests.                                                                                                                                                                      |
| [stubGlobals](variables/stubGlobals.md)                     | Call during test setup to stub browser globals like ResizeObserver, matchMedia, location, and visualViewport.                                                                                                              |
