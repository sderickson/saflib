...
Use [add-cron-job](../cron-http/docs/workflows/add-job.md) to add a new cron job to your package. You can also create a new cron package with [cron/init](../cron-http/docs/workflows/init.md).
...
| [@saflib/cron-spec](../cron-spec/docs/ref/index.md)          | OpenAPI spec and request types          | [Code reference](../cron-spec/docs/ref/index.md)                                                       |
