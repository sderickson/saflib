...
import { upsertSecretEncryptionKey, encryptSecret, decryptSecret } from "./encryption.js";
...
describe("upsertSecretEncryptionKey", () => {
  ...
  it("should return consistent key in test environment", () => {
    ...
    expect(key1).toBe("0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef");
  ...
  it("should return existing key if file exists", () => {
    ...
    try {
      ...
      const existingKey = "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789";
...
describe("integration test", () => {
  it("should encrypt a value, then decrypt it to get original value back", () => {
    const originalValue = "This is a secret value with special chars: !@#$%^&*()_+{}|:<>?";
    const key = upsertSecretEncryptionKey();
