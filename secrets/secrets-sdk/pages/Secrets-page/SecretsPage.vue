...
import { Secrets_page_page as strings } from "./SecretsPage.strings";
import { useSecretsPageLoader } from "./SecretsPage.loader";
import { useReverseT } from "../spa-template/i18n.ts";

const { t } = useReverseT();

const { profileQuery } = useSecretsPageLoader();
