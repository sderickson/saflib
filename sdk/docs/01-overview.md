...
| Export                                                                                                                                          | Role                                                                                                                                                     |
| ----------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`createSafClient`](./ref/@saflib/sdk/variables/createSafClient.md) / [`handleClientMethod`](./ref/@saflib/sdk/variables/handleClientMethod.md) | Typed [`openapi-fetch`](https://openapi-ts.dev/openapi-fetch/) client with CSRF, subdomain routing, and TanStack error typing                            |
| [`createTanstackQueryClient`](./ref/@saflib/sdk/variables/createTanstackQueryClient.md)                                                         | Default QueryClient (stale time, selective retries) for SPAs                                                                                             |
...
| [`./testing`](./ref/@saflib/sdk/testing/index.md)                                                                                               | [`withVueQuery`](./ref/@saflib/sdk/testing/functions/withVueQuery.md), [`typedCreateHandler`](./ref/@saflib/sdk/testing/variables/typedCreateHandler.md) |
| [`./testing/mock`](./03-testing.md#msw-and-fakes)                                                                             | Vitest + MSW `setupMockServer` helper                                                                                                                    |
