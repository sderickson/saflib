...
`vue-tsc -b`), see [@saflib/imports composite type guidance](../../imports/docs/03-composite-type-guidance.md)
and [project references](../../imports/docs/02-project-references.md).
