...
describe("generateDockerfiles", () => {
  it("should generate the correct dockerfiles", () => {
    ...
    expect(dockerfile).toContain(
      "COPY ./.docker/foo-auth-web-client/package.json ./package.json",
    );
    expect(dockerfile).toContain(
      "COPY --parents ./package-lock.json ./clients/web-auth/package.json ./saflib/auth-vue/package.json ./saflib/auth-spec/package.json ./saflib/openapi-specs/package.json ./saflib/vue-spa/package.json",
    );
    expect(dockerfile).toContain(
