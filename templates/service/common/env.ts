/**
 * Environment variables for the `@saflib/templates-service-common` package, including inherited variables.
...
export interface TemplatesServiceCommonEnvSchema {
  /**
  ...
  TEMPLATES_SERVICE_HTTP_HOST: string;
  /**
...
/**
 * `process.env` casted to the `TemplatesServiceCommonEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TemplatesServiceCommonEnvSchema;
