/**
 * Environment variables for the `@saflib/templates-monolith` package, including inherited variables.
...
export interface TemplatesMonolithEnvSchema {
  /**
...
/**
 * `process.env` casted to the `TemplatesMonolithEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TemplatesMonolithEnvSchema;
