/**
 * Environment variables for the `@saflib/templates-clients` package, including inherited variables.
...
export interface TemplatesClientsEnvSchema {
  /**
...
/**
 * `process.env` casted to the `TemplatesClientsEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TemplatesClientsEnvSchema;
