...
docker_build ./templates/clients/root/Dockerfile \
  -t saflib-templates-static-root:latest &
pids+=($!)

docker_build ./templates/service/monolith/Dockerfile \
  -t saflib-templates-monolith:latest &
pids+=($!)

docker_build ./templates/clients/build/Dockerfile \
...
docker_build ./templates/dev/Dockerfile \
