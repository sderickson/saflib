/**
 * Environment variables for the `template-package-service-common` package, including inherited variables.
...
export interface TemplatePackageServiceCommonEnvSchema {
  /**
...
/**
 * `process.env` casted to the `TemplatePackageServiceCommonEnvSchema` type.
 */
export const typedEnv = (globalThis.process
  ? process.env
  : {}) as unknown as TemplatePackageServiceCommonEnvSchema;
